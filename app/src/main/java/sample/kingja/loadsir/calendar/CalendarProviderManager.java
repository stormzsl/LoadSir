...
import static sample.kingja.loadsir.calendar.TimeUtils.checkContextNull;
    ...
    private static String getFullRRuleForRRule(String rRule, long beginTime, long endTime) {
        ...
        switch (rRule) {
            ...
            case RRuleConstant.REPEAT_WEEKLY_BY_SU:
                return builder.append(rRule).append(TimeUtils.getFinalRRuleMode(endTime)).toString();
            case RRuleConstant.REPEAT_CYCLE_WEEKLY:
                return builder.append(rRule).append(TimeUtils.getWeekForDate(beginTime)).append("; UNTIL = ")
                        .append(TimeUtils.getFinalRRuleMode(endTime)).toString();
            case RRuleConstant.REPEAT_CYCLE_MONTHLY:
                return builder.append(rRule).append(TimeUtils.getDayOfMonth(beginTime))
                        .append("; UNTIL = ").append(TimeUtils.getFinalRRuleMode(endTime)).toString();
            default:
                return rRule;
        }
    }
